...
class SuvWidget extends StatefulWidget {
  const SuvWidget({Key? key}) : super(key: key);

  @override
  _SuvWidgetState createState() => _SuvWidgetState();
}

class _SuvWidgetState extends State<SuvWidget> {
  ...
  void initState() {
    super.initState();
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Suv'});
  }
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: FlutterFlowIconButton(
          ...
          onPressed: () async {
            logFirebaseEvent('SUV_PAGE_chevron_left_ICN_ON_TAP');
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Text(
                  'Retrouvez tous nos véhicules de type SUV. Naviguez à travers les différents onglets en fonction de la categorie que vous recherchez.',
                  ...
                  return Row(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          onTap: () async {
                            logFirebaseEvent('SUV_PAGE_Text_wl8sem7j_ON_TAP');
                                      ...
                                      itemBuilder: (context, listViewIndex) {
                                        ...
                                        return Padding(
                                          ...
                                          child: InkWell(
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'SUV_PAGE_Container_13dxuo4y_ON_TAP');
                                              logFirebaseEvent(
                                      ...
                                      itemBuilder: (context, listViewIndex) {
                                        ...
                                        return Padding(
                                          ...
                                          child: InkWell(
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'SUV_PAGE_Container_gvhdhrdj_ON_TAP');
                                              logFirebaseEvent(
                                                  'Container_Navigate-To');
                                              context.pushNamed(
                                                'VenteDetailsOfcar',
                                                                  ...
                                                                  itemBuilder:
                                                                    ...
                                                                    return InkWell(
                                                                      onTap:
                                                                          () async {
                                                                        logFirebaseEvent(
                                                                            'SUV_PAGE_Image_voro0lrj_ON_TAP');
                                                                        logFirebaseEvent(
                                                                            'Image_Expand-Image');
                                                                        await Navigator
                                                                            .push(
