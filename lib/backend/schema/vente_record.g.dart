...
part of 'vente_record.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<VenteRecord> _$venteRecordSerializer = new _$VenteRecordSerializer();

class _$VenteRecordSerializer implements StructuredSerializer<VenteRecord> {
  @override
  final Iterable<Type> types = const [VenteRecord, _$VenteRecord];
  @override
...
class _$VenteRecord extends VenteRecord {
  ...
  @override
  VenteRecord rebuild(void Function(VenteRecordBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  VenteRecordBuilder toBuilder() => new VenteRecordBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is VenteRecord &&
        marque == other.marque &&
...
class VenteRecordBuilder implements Builder<VenteRecord, VenteRecordBuilder> {
  ...
  @override
  void replace(VenteRecord other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$VenteRecord;
  }
