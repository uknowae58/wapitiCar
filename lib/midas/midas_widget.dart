...
class MidasWidget extends StatefulWidget {
  const MidasWidget({Key? key}) : super(key: key);

  @override
  _MidasWidgetState createState() => _MidasWidgetState();
}

class _MidasWidgetState extends State<MidasWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Midas'});
  }
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: ClipRRect(
                                        borderRadius: BorderRadius.circular(8),
                                        child: Image.asset(
                                          'assets/images/pasted-image-0-2-1-1024x646.png',
                                          width: 100,
                                          height: 100,
                                          fit: BoxFit.cover,
                                        ),
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            Expanded(
                                              child: Text(
                                                'Reparation impact impacte pare-brise',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyText1
                                                        .override(
                            ...
                            child: Row(
                              ...
                              children: [
                                ClipRRect(
                                  borderRadius: BorderRadius.circular(12),
                                  child: Image.asset(
                                    'assets/images/pngwing.com_(8).png',
                                    width: 36,
                                    height: 36,
                                    fit: BoxFit.cover,
                                  ),
                            ...
                            child: Row(
                              ...
                              children: [
                                ClipRRect(
                                  borderRadius: BorderRadius.circular(12),
                                  child: Image.asset(
                                    'assets/images/pngwing.com_(9).png',
                                    width: 36,
                                    height: 36,
                                    fit: BoxFit.cover,
                                  ),
                            ...
                            child: Row(
                              ...
                              children: [
                                ClipRRect(
                                  borderRadius: BorderRadius.circular(12),
                                  child: Image.asset(
                                    'assets/images/pngwing.com_(12).png',
                                    width: 36,
                                    height: 36,
                                    fit: BoxFit.cover,
                                  ),
                            ...
                            child: Row(
                              ...
                              children: [
                                ClipRRect(
                                  borderRadius: BorderRadius.circular(12),
                                  child: Image.asset(
                                    'assets/images/pngwing.com_(10).png',
                                    width: 36,
                                    height: 36,
                                    fit: BoxFit.cover,
                                  ),
                            ...
                            child: Row(
                              ...
                              children: [
                                ClipRRect(
                                  borderRadius: BorderRadius.circular(12),
                                  child: Image.asset(
                                    'assets/images/clim1200x360.webp',
                                    width: 36,
                                    height: 36,
                                    fit: BoxFit.cover,
                                  ),
