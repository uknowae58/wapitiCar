    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: FlutterFlowIconButton(
          ...
          onPressed: () async {
            logFirebaseEvent('FAVORIS_PAGE_chevron_left_ICN_ON_TAP');
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Text(
                  'Tous vos véhicules favoris en vente et en location.                      ',
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          onTap: () async {
                            logFirebaseEvent(
                                'FAVORIS_PAGE_Text_xxrbc43x_ON_TAP');
                                      ...
                                      itemBuilder: (context, listViewIndex) {
                                        ...
                                        return Padding(
                                          ...
                                          child: InkWell(
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'FAVORIS_PAGE_Container_2cygn485_ON_TAP');
                                              logFirebaseEvent(
                                      ...
                                      itemBuilder: (context, listViewIndex) {
                                        ...
                                        return Padding(
                                          ...
                                          child: InkWell(
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'FAVORIS_PAGE_Container_titx7pzf_ON_TAP');
                                              logFirebaseEvent(
                                                  'Container_Navigate-To');
                                              context.pushNamed(
                                                'VenteDetailsOfcar',
                                                                  ...
                                                                  itemBuilder:
                                                                    ...
                                                                    return InkWell(
                                                                      onTap:
                                                                          () async {
                                                                        logFirebaseEvent(
                                                                            'FAVORIS_PAGE_Image_8cwr2zx8_ON_TAP');
                                                                        logFirebaseEvent(
                                                                            'Image_Expand-Image');
                                                                        await Navigator
                                                                            .push(
