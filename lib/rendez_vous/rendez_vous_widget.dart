        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    FlutterFlowIconButton(
                      ...
                      onPressed: () async {
                        logFirebaseEvent('RENDEZ_VOUS_PAGE_house_ICN_ON_TAP');
              ...
              StreamBuilder<List<CommandeVenteRecord>>(
                  ...
                  return SingleChildScrollView(
                    child: Column(
                      ...
                      children: List.generate(
                          columnCommandeVenteRecordList.length, (columnIndex) {
                                    ...
                                    children: [
                                        ...
                                        children: [
                                          Text(
                                            dateTimeFormat('yMMMd',
                                                columnCommandeVenteRecord.date),
                                      ...
                                      StreamBuilder<VenteRecord>(
                                        stream: VenteRecord.getDocument(
                                            columnCommandeVenteRecord.vehicule),
                                        builder: (context, snapshot) {
                                          // Customize what your widget looks like when it's loading.
                                          if (!snapshot.hasData) {
                                            return Center(
                                          ...
                                          final rowVenteRecord = snapshot.data;
                                          return Row(
                                            mainAxisSize: MainAxisSize.max,
                                            children: [
                                              Text(
                                      ...
                                      Padding(
                                        ...
                                        child: StreamBuilder<UsersRecord>(
                                          stream: UsersRecord.getDocument(
                                              columnCommandeVenteRecord.gerant),
                                          builder: (context, snapshot) {
                                            // Customize what your widget looks like when it's loading.
                                            if (!snapshot.hasData) {
                                              return Center(
